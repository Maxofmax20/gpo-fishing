      ...
      <Section title="Fishing">
        ...
        >
          <Steps>
            ...
            <Step n={5} title="Click the Middle button (OK / Close)" sub="Auto-defaults to center (50.1%, 90.6%). Re-pick only if your dialog is positioned differently." done={!!(s.points.purchase[3] ?? s.points.purchase[1])}>
              <PointField target="purchase4" value={s.points.purchase[3] ?? s.points.purchase[1]} clearable onCleared={() => update((x) => void (x.points.purchase[3] = null))} />
            </Step>
